...
1. S3 콘솔 → "버킷 만들기"
2. 버킷 이름: `silee-workout-tracker-photos` (전 세계 유일해야 함, 본인 prefix 권장)
...
aws s3api create-bucket \
  --bucket silee-workout-tracker-photos \
  ...
  "Statement": [
    {
      ...
      "Resource": "arn:aws:s3:::silee-workout-tracker-photos/*"
    }
  ]
}
```
...
$env:AWS_S3_BUCKET = "silee-workout-tracker-photos"
```
...
export AWS_S3_BUCKET=silee-workout-tracker-photos
```
